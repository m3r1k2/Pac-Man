...
class Level2:
    ...
    def setupWalls(self, wall_color):
        self.wall_sprites = pygame.sprite.Group()
        wall_positions = [
            [0, 0, 6, 606], [600, 0, 6, 606], [0, 0, 606, 6], [0, 600, 606, 6],
            [60, 60, 186, 6], [360, 60, 186, 6],
            [60, 120, 66, 6], [180, 120, 246, 6], [480, 120, 66, 6],
            [120, 180, 126, 6], [360, 180, 126, 6],
            [180, 240, 246, 6],
            [60, 300, 66, 6], [480, 300, 66, 6],
            [120, 360, 126, 6], [360, 360, 126, 6],
            [60, 420, 66, 6], [480, 420, 66, 6],
            [180, 480, 246, 6],
            [0, 300, 66, 6], [540, 300, 66, 6],
            # Добавленные стены для заполнения пространства снизу
            [120, 480, 126, 6], [300, 480, 126, 6], [240, 540, 6, 66],
            [60, 540, 66, 6], [360, 540, 186, 6], [180, 600, 246, 6]
        ]
        for wall_position in wall_positions:
            wall = Wall(*wall_position, wall_color)
            self.wall_sprites.add(wall)
...
class Level3:
    ...
    def setupWalls(self, wall_color):
        ...
        wall_positions = [
            ...
            [60, 120, 66, 6], [180, 120, 246, 6], [480, 120, 66, 6],
            [120, 180, 126, 6], [360, 180, 126, 6],
            [60, 240, 66, 6], [480, 240, 66, 6],
            [180, 300, 246, 6],
            [120, 360, 126, 6], [360, 360, 126, 6],
            [60, 420, 66, 6], [480, 420, 66, 6],
            [180, 480, 246, 6],
            [0, 300, 66, 6], [540, 300, 66, 6],
            # Дополнительные стены внутри уровня
            [180, 240, 6, 126], [420, 240, 6, 126],
            [240, 360, 126, 6],
            [240, 480, 6, 66], [360, 480, 6, 66]
        ]
        for wall_position in wall_positions:
            wall = Wall(*wall_position, wall_color)
            self.wall_sprites.add(wall)
